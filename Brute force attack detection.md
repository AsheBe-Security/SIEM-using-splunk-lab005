...
4. Check if log ingestion is successful on splunk server
...
5. Simulate brute force attack on the machine running forwarder from two machine; windows host machine and ubuntu vm
...
7.  Create splunk alerts from the captured logs
